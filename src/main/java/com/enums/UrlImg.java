...
public enum UrlImg {
	AMGAPI_NoComplete("amigoemapuros1_nocomplete.jpg"), AMGAPII_NoComplete(
			"amigoemapuros2_nocomplete.jpg"), AMGAPIII_NoComplete("amigoemapuros3_nocomplete.jpg"), CONQI_NoComplete(
					"conquistador1_nocomplete.jpg"), CONQII_NoComplete(
							"conquistador2_nocomplete.jpg"), CONQIII_NoComplete(
									"conquistador3_nocomplete.jpg"), TRAEQ_NoComplete(
